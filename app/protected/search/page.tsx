...
export default function SearchPage() {
  ...
  const { results: searchResults, isLoading: searchLoading, error: searchError } = useTransactionSearch(searchQuery);
  ...
  useEffect(() => {
    ...
    const newUrl = params.toString() ? `/protected/search?${params}` : '/protected/search';
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between pt-4 pb-2">
          <div className="flex items-center w-full gap-3">
            <button
              className="h-10 px-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors flex items-center justify-center"
            ...
            <div className="relative flex-1">
              <input
                ...
                className="w-full h-10 pl-3 pr-10 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none"
                autoFocus
              />
        ...
        {searchLoading ? (
          ...
          <div className="mt-8 text-center py-8">
            <p className="text-red-600 dark:text-red-400">Error searching transactions: {searchError.message}</p>
          </div>
          ...
          <div className="mt-8 text-center py-8">
            <p className="text-gray-500 dark:text-gray-400">Start typing to search transactions...</p>
          </div>
        )}
      </div>
