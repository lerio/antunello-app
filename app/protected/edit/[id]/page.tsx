    ...
    >
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="w-full space-y-6">
          {transaction.bonus_kind ? (
            // Bonus transactions (TR saveback/round-up) are system-generated
            // and unmodifiable — show a read-only view linking to the parent
            // instead of the edit form and danger zone.
            <div className="w-full max-w-4xl mx-auto bg-white rounded-2xl shadow-xl p-6 md:p-8 space-y-6">
              <div className="flex items-center justify-between">
                <Button variant="outline" onClick={handleBack}>
                  Back
                </Button>
                <span className="text-xs uppercase font-semibold text-gray-400">
                  Generated by Trade Republic import
                </span>
              </div>
              ...
              <div className="space-y-1">
                ...
                <p className="text-gray-500">
                  This transaction was created automatically from a Trade
                  Republic card payment and cannot be edited or deleted on its
                  own. Delete the original transaction to remove it.
                </p>
              </div>
              ...
              <Button
                onClick={() =>
                  router.push(`/protected/edit/${transaction.parent_transaction_id!}`)
                }
              >
